...
namespace Service.Utils
{
    ...
    public class TableConnector
    {
        ...
        private TableConnector(Func<DataTable> mainTableHandler, params string[] renameColumns)
        {
            Func<DataTable> func = () =>
            {
                ...
                if (renameColumns.Length > 0)
                    this.SeekColumnName = renameColumns.ElementAt(0);
                else
                    this.SeekColumnName = mainTable.Columns[0].ColumnName;
        ...
        {
            this.TableConstructors.Add(new TableConstructor(reportForm.GenerateTable, SortNum++));
            return this;
        }
